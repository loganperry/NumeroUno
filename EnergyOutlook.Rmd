...
#Challenge: provide a research task and find data with the same characteristics as this assignment. 
# I would expect number of visits at a ski resort (for example, Park City Mountain) to fluctuate from month to month and like our observed data, peak in the winter months. 
```
